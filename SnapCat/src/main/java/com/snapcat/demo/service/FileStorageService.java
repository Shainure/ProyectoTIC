...
import com.snapcat.demo.exception.FileStorageException;
import com.snapcat.demo.exception.MyFileNotFoundException;
import com.snapcat.demo.property.FileStorageProperties;
...
public class FileStorageService {
    ...
    public FileStorageService(FileStorageProperties fileStorageProperties) {
        ...
        try {
            ...
            throw new FileStorageException("No se pudo crear directorio para guardar los archivos.", ex);
        }
    }
